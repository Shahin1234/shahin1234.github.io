...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
//        $data1 = DB::table('profile')
//            ->where('profile.student_id', $data['student_id'], '=')
//            ->first();
//
//        if ($data1==null)
...
//
        ...
        return Validator::make($data, [
            'student_id' => 'exists:profile,student_id|required|string|max:25|unique:users',
            'guarcontact' => 'exists:profile,guarnumber',
            'cnumber' => 'exists:profile,ctactnumber',
